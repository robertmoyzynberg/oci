  ...
  memes: [
    {
      ...
      related_flows: [
        { flowId: "consumption", modifier: 90, label: "withdrawal rate" },
      ],
    ...
    },
    {
      ...
      related_stocks: ["reservoir_level"],
      related_flows: [
        { flowId: "consumption", modifier: -70, label: "withdrawal rate" },
      ],
  ...
  memes: [
    {
      ...
      related_flows: [
        { flowId: "infection", modifier: 80, label: "transmission" },
      ],
    ...
    },
    {
      ...
      related_flows: [
        { flowId: "infection", modifier: -85, label: "transmission" },
        { flowId: "vaccination", modifier: 60, label: "vaccine uptake" },
      ],
